...
class FMConnector
{
     ...
     *
     * @param EnvironmentManager $conf Standard configuration class reference
     * @throws Exception
     */
     ...
     * @param array $options Options which are used when records are being extracted. See _extractRecords
     *                            for details
     *
     * @return array
     * @throws FMException
     ...
     * @param string $return The data to be returned, see _processReturn for options.
     ...
     * @param array $data A array of data to be inserted into the layout
     ...
     *
     * @param string $layout The FileMaker layout to insert data via
     * @param integer $recid The FileMaker internal record ID (as viewed with Get(RecordID) in FM)
     * @param array $data A array of data to be updated via the layout
     * @param string $return What data should be returned as result of the insert.
     *                                See _processReturn for options.
     *                                Defaults to null
     *
     ...
     * delete
     *
     * Delete a record from FileMaker
     *
     * @param string $layout
     * @param integer $recID
     *
     * @throws FMException
     */
    public function delete($layout, $recID)
    {
        $cmd = $this->fm->newDeleteCommand($layout, $recID);
        $res = $cmd->execute();
     ...
     *
     * @param array $log The data to be logged. Possible array keys are:
     ...
     *
     *                        NOTE: array keys are case sensitive.
     * @return array
     */
     ...
     * IMPORTANT NOTE: This method only works for external containers
     *
     * @param string $path
     ...
     * @param array $opts The options to use when processing records. See _extractRecords for details
     *
     ...
     * @param array $options A array of options. Current options are
     *                            ids    boolean    should the record and mod IDs be in the returned set
     *                            defaults to true
     * @return array            A array of the records extracted from the data set
     */
